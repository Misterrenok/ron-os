...
1. For any nontrivial nutrition analysis/optimization, read `references/nutrition/method.md` before concluding. For any "ideal nutrition" / Nutrition Score / 100-point rubric request, also read `references/nutrition/ideal-nutrition-score.md` and keep quality, execution status and confidence separate.
