...
- **2026-09-02 user-supplied candidate evidence — Pifagor Trade Conservative:** Ron reports that a close acquaintance uses the Conservative bot, deposited approximately **USD 700**, then left it running without active management for about **5 months**. Based on the acquaintance's current balance as shown/told to Ron, Ron estimated an annualized return of roughly **52%**. This is useful first-hand anecdotal evidence but remains **UNVERIFIED** without the acquaintance's Bybit deposit/equity/P&L history and does not establish long-run return or drawdown. The bot remains an OPEN candidate, not an approved allocation.
...
## Source boundary
Recovered from older persistent Ron context plus direct Ron updates on 2026-09-01 and current official/document evidence where noted. Current direct confirmations include approximately **USD 600 equivalent** in savings, cash TRY salary receipt, foreign-student bank profile, currency-flexible sister repayment, **~USD 1,532 remaining sister debt**, low-maintenance/high-risk-adjusted-return investment objective, and departure before the **2027-07-27** permit deadline. The 2026-09-02 Pifagor acquaintance result is user-reported candidate evidence only and is explicitly not promoted to verified long-run strategy performance. This owner deliberately excludes identifying financial account details.
