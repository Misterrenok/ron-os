...
- **No final portfolio allocation has been approved by Ron yet.** The assistant's latest candidate of roughly **50% TL para piyasası fonu / 50% EUR for new savings** is a recommendation generated under the near-term Germany constraint, **not a locked user decision**. Re-check current rates, inflation, FX expectations, taxes, fund fees/liquidity and banking/KYC practicality before execution.
