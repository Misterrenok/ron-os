...
- **2026-09-04 direct Ron update:** employer said that if October closes well, he will **likely** raise salary from **35,000 TL to 42,000 TL starting in November**, but the decision will be made only at the **end of October**. This is a **conditional/unconfirmed future change**, not current or guaranteed income. For a minimum-reliable November budget prepared before that decision, use **35,000 TL** as the guaranteed salary base; treat **42,000 TL** only as an upside scenario until explicitly confirmed.
