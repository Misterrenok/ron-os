...
## Germany strategy — last-confirmed direction
- Confirmed target direction: **Fachinformatiker Systemintegration (Ausbildung)**.
- Pflege/care route was recorded as rejected.
- Two entry strategies remained **not finally chosen** as of this snapshot:
  1. direct vocational-training route from Istanbul (historically discussed around §16a), requiring the language/contract conditions then applicable;
