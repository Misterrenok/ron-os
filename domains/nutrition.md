...
| 17 | Food safety / doneness / cooling / storage | PASS-DESIGN | Chicken safety endpoint remains **74°C / 165°F measured with a food thermometer**; current official USDA/FSIS guidance says a thermometer is the only sure way to verify that poultry reached a bacteria-destroying temperature, while appearance/doneness cues are not reliable safety tests. Ron currently does not own a food thermometer, so the safety rule is designed but one small equipment gap remains before verified execution. Prompt shallow cooling and <=4°C fridge target remain current; leftovers should be refrigerated promptly, divided into shallow containers, and generally used refrigerated within 3–4 days or frozen. Mon–Wed chicken stays refrigerated from the Sunday batch; Thu–Sat chicken is cooked Wednesday. Lentils: ~400 g Sun–Wed refrigerated and ~300 g Thu–Sat frozen after cooling, thawed in fridge Wednesday. Hard-cooked eggs remain within the 7-day refrigerated window. |
| 18 | Actual dishes / taste / moisture / texture | PASS-DESIGN | Sensory audit rerun 2026-09-23. The food is realistically edible, but three failure points needed explicit technique: oat-flour porridge can become gluey; cold breast can become dry; the no-yogurt 16:45 meal can become a dry bread+chicken assembly. Current no-calorie fixes: breakfast mixes ~80 g oat flour with ~250 ml milk **plus enough water (~80–120 ml starting range) to reach spoonable porridge**, stir before/mid-microwave, then add flax/pekmez after heating; chicken is cut small/uniform, cooked moist/covered only until the largest piece reaches 74°C, rested covered, and portioned with a little retained cooking juice; cold pasta dressing uses the existing yogurt/oil with lemon + paprika + 1–2 tbsp water to emulsify, and pasta is cooked fully tender rather than very firm because refrigeration hardens it. The 16:45 chicken is finely cut/shredded and kept with a little cooking juice; tomato stays separate until eating so bread does not become soggy. Lentil dinners are a warm lentil-yogurt bowl with cumin/mint/paprika, oil added at the end, bread/Nimet separate. Sardine meals are eaten as separate components with lemon/tomato rather than mixing fish into yogurt/lentils. Real taste remains empirical; same dish disliked twice still triggers seasoning/texture redesign before nutrient changes. |
...
| 20 | Batch cooking / raw-to-cooked yield / cleanup | OPEN-EMPIRICAL | Working production method is now concrete: Sunday after library uses three parallel streams if equipment allows—pasta pot (~420 g dry), red-lentil pot for the weekly ~700 g cooked target, and covered moist chicken pan (~650 g raw); Wednesday repeats pasta (~420 g dry) + chicken (~750 g raw) and moves the frozen lentil portion to the fridge. Chicken should be pre-cut uniformly by seller when possible, seasoned with curry/paprika/pepper, cooked covered with a small splash of water/retained juices, and stopped once the largest piece reaches 74°C to avoid dry breast. Pasta for cold eating should be tender (not hard al dente), drained and spread/portioned promptly rather than left in a hot mass. Red lentils should finish thick/spoonable, not soupy, so they reheat/freeze well. Portion cooked food into shallow/smaller containers and refrigerate promptly; do not wait for a deep pot to reach room temperature. Actual first-run duration, simultaneous burner/pan capacity, cooling space, storage-vessel capacity and cleanup remain empirical. |
...
| 28 | Cognitive load / automation | PASS-LIVE | Full routine nutrition automation is live and self-contained again. Final safety sync completed 2026-09-23: Friday procurement now says to acquire an instant-read food thermometer if not already owned and strongly recommends ~1-g kitchen scales; Saturday fresh-food closeout repeats the thermometer gate before chicken prep; Sunday and Wednesday chicken tasks now explicitly require checking the thickest/largest piece with the thermometer and not stopping before >=74°C, while rejecting color/juice as safety proof. All four tasks were read back with their original schedules/recurrence and `Europe/Istanbul`. Routine nutrition execution no longer depends on Ron remembering this equipment/safety rule. |
...
| 31 | Service leverage / practical execution hacks | PASS-DESIGN | Current high-value rules: ask seller to split/cut the ~1.4-kg chicken into ~650 g + ~750 g uniform pieces; separate durable-stock delivery/earlier purchase from Saturday perishables; freeze bread in near-term portions; stage next-morning oats/dry food the prior evening; parallel-cook only where safe; keep fruit whole; use seller prep/delivery when it beats friction. **Two small tools now have unusually high ROI for this exact system:** (1) a basic digital kitchen scale (~1-g resolution) to eliminate repeated package-fraction/mental arithmetic for 80/30/15/5/10–20/420-g quantities; (2) an instant-read food thermometer to make the chicken 74°C safety endpoint actually verifiable instead of relying on appearance. Neither changes nutrient architecture; the thermometer closes a safety-verification gap, while the scale primarily reduces cognitive load and portion error. |
