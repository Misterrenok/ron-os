...
| 13 | Sodium / salt / iodine interaction | PASS-DESIGN | Clean-week donor model averages ~1,218 mg sodium/day before discretionary salt. Exact prior added-salt behavior is UNKNOWN, so the assistant-selected launch control is a weekly iodized-table-salt budget of about 2 level teaspoons (~10–12 g/week depending crystal density, ~1.4–1.7 g/day average), not a claim about Ron's old habit. That adds roughly ~560–680 mg sodium/day, for a modeled total ~1,780–1,900 mg/day; use mainly for taste and do not rely on salt alone to prove iodine adequacy. |
...
| 17 | Food safety / doneness / cooling / storage | PASS-DESIGN | Chicken 74°C target, prompt shallow cooling and <=4°C fridge target remain current. The revised split production keeps Mon–Wed chicken and Sun–Wed lentils from the Sunday batch in the refrigerator, then cooks Thu–Sat chicken and Thu–Sun lentils on Wednesday; freeze only the Sunday lentil portion after cooling and move it to the refrigerator Saturday night. This avoids unnecessary multi-day thaw holds. Hard-cooked eggs are used within the 7-day refrigerated window. Execution reliability remains empirical. |
...
| 20 | Batch cooking / raw-to-cooked yield / cleanup | OPEN-EMPIRICAL | Assistant working correction after whole-lifecycle audit: split protein production again rather than forcing all-week chicken/lentils into Sunday after the 09:00–18:00 library day. Saturday evening: boil 8 eggs + prep Sunday breakfast. Sunday after library: ~650 g raw chicken for Mon/Tue/Wed, ~400 g cooked lentils for Sun–Wed, Mon–Wed pasta (~420 g dry) and Mon–Wed oat breakfasts. Wednesday after work: ~750 g raw chicken for Thu/Fri/Sat, ~400 g cooked lentils for Thu–Sun, Thu–Sat pasta (~420 g dry) and Thu–Sat oat breakfasts; freeze only Sunday's lentils after cooling. This preserves weekly totals, reduces freezer/thaw complexity and spreads workload. Actual first-run duration, pan/stove throughput, storage-vessel capacity and cleanup remain empirical. |
...
| 28 | Cognitive load / automation | STALE-LIVE | Obsolete TickTick/Calendar nutrition scaffolding was cleaned. Cronometer weeks 2026-09-28..10-04 and 2026-10-05..11 have the correct weekly food totals and exclude D3, but their meal-group placement still reflects the pre-one-container version: on Mon–Sat the 50 g yogurt moved from 16:45 to home dinner has not been mirrored. On 2026-09-22 Ron explicitly authorized exactly that meal-placement correction with no quantity changes, but the Cronometer connector exposed no callable action in the current session, so the live correction remains technically unexecuted. Do not use Cronometer as exact meal-timing instructions until a later successful write + read-back. |
...
- Revised intended production: Sunday cooks ~650 g raw chicken -> ~440 g cooked for Mon/Tue/Wed; ~400 g cooked lentils for Sunday through Wednesday; ~420 g dry pasta for Mon–Wed; and Mon–Wed oat breakfasts. Wednesday cooks ~750 g raw chicken -> ~510 g cooked for Thu/Fri/Sat; ~400 g cooked lentils for Thu–Sun; ~420 g dry pasta for Thu–Sat; and Thu–Sat oat breakfasts.
- Refrigerate portions that will be used within the normal 3–4-day window. Freeze only the Sunday lentil portion from the Wednesday batch after prompt cooling; move it to the refrigerator Saturday night.
