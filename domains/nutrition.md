...
| 28 | Cognitive load / automation | STALE-LIVE | Routine nutrition automation is live, but the final food-safety audit exposed one upstream execution gap: chicken tasks instruct `74°C` even though Ron currently has no food thermometer, and the procurement reminders do not yet tell him to acquire one. Kitchen-scale acquisition is also a high-ROI cognitive-load improvement. Until Ron explicitly authorizes the exact TickTick delta—add thermometer + optional/strongly-recommended digital scale to procurement and make chicken-task wording require thermometer verification before trusting the 74°C endpoint—the live layer is not fully self-contained. Timing/meal quantities remain correct. |
