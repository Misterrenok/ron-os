...
| 8 | Vitamin D / supplements | PASS-DESIGN | The prior Cronometer ~169 IU/day food-only result over-transferred sardine fish mass because it treated each 125-g Dardanel can as 125 g drained fish; the physical label shows 85 g drained fish/can. A USDA-style sardine donor scaled to the actual ~170 g drained fish/week would lower modeled food vitamin D by roughly ~30 IU/day, putting the food-only estimate nearer ~140 IU/day. The assistant-selected 400 IU/day D3 top-up remains a reasonable simple planning dose (~540 IU/day modeled total, with product/database uncertainty), still not purchased/not started and with no automatic K2 requirement. |
