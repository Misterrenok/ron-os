...
| 8 | Vitamin D / supplements | PASS-LIVE | **Ron-originated decision:** use D3+K2 together rather than D3-only. **Assistant-selected concrete product:** Nutraxin D3K2 120 Tablet. Official composition per tablet: D3 (cholecalciferol) **1000 IU / 25 µg** + K2 **MK-7 25 µg**. Current online price target is roughly ~200–230 TL for 120 tablets; markedly higher prices should trigger seller comparison. Execution: 1 tablet daily with/after the 12:00 meal once physically purchased. TickTick procurement and daily reminder are synchronized. This replaces the prior assistant-selected Youplus D3-only 400-IU plan. K2 is being used here as Ron's preference for a combined low-friction regimen in the setting of uncertain/likely modest dietary K2 exposure, not because K2 is required for intestinal D3 absorption. |
