...
| 28 | Cognitive load / automation | PASS-DESIGN | Live Cronometer residues were fixed and read back on 2026-09-23: the six 50-g yogurt rows on 28.09–03.10 were moved from snacks to dinner without changing daily totals; the 30.09 and 04.10 sardine rows now use 85 g of the drained-sardine donor plus a Dardanel correction layer. The composite per 125-g can resolves exactly to 266.25 kcal / 27.20 P / 17.20 F / 0.50 C / 850 mg sodium, while donor-only fish micronutrients inherit 85 g fish/can. Dardanel's exact 1420 mg EPA+DHA/100 g remains an external label value because the current connector custom-food schema cannot encode that omega-3 field exactly. No further known Cronometer live residue remains for 28.09–04.10. |
