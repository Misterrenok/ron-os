...
| 8 | Vitamin D / supplements | PASS-DESIGN | **Assistant-selected working decision, not Ron-originated:** use a simple **400 IU/day vitamin D3** baseline once an appropriate product is physically purchased; no automatic K2 requirement. This decision does not require separate approval under Ron's delegation rule, but provenance must remain explicit. Until a product is actually purchased/started, intake remains PLANNED rather than factual. Food-only vitamin D remains modeled roughly ~140 IU/day after correcting sardine fish mass; product/database uncertainty is large enough that no fine-grained dose chasing is justified. Reopen for meaningful sun-exposure change, labs/clinical advice, product-dose mismatch or other material health evidence. |
