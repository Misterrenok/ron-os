...
| 8 | Vitamin D / supplements | PASS-LIVE | **Assistant-selected, not Ron-originated:** default product is **Youplus Vitamin D3 400 IU 20 ml Oral Sprey (Abdi İbrahim)**, 1 puff = 10 µg / 400 IU D3. Current online reference: Nar Ecza ~50 TL (2026-09-23 crawl); manufacturer confirms the 400-IU formulation. Take **1 puff daily with/after the 12:00 meal containing fat** once physically purchased. TickTick purchase text and a daily 12:00 reminder are live/read-back verified (`6ab3b5eb8f080aea1acba8ef`, Europe/Istanbul). K2 is **not** added by default: it is not required for intestinal vitamin-D absorption; dietary fat improves D absorption. Vitamin K has separate roles in vitamin-K-dependent proteins such as osteocalcin/MGP, but routine K2 supplementation in a healthy young adult has no established requirement merely because D3 is used. Combination products such as Youplus D3K2 provide 1000 IU D3 + 20 µg K2 per drop, which would materially change the adopted D dose without a separate indication. Planned intake is not factual until the product is actually purchased/used. |
