...
Status: **PASS — GITHUB_CANONICAL / CONTINUITY + ADAPTIVE-METAREASONING FRESH-CHAT PRODUCTION REVALIDATED; SPARSE-INTENT REFINEMENT AWAITS DIRECT PRODUCTION PROBE**
...
## Open residue
- **OPEN / production probe — sparse intent:** a genuinely fresh nontrivial request expressed only as a terse goal should demonstrate that the governor performs specification completion instead of returning a surface template or broad questionnaire.
