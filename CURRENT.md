...
- Historical migration/remediation detail stays in history/Git rather than this checkpoint.

## Reasoning architecture
- **ADAPTIVE METAREASONING GOVERNOR INSTALLED 2026-08-24:** `PROTOCOL.md` places a bounded meta-controller above systems thinking and other named methods. It preserves Ron's explicit objective, chooses/constructs representation and reasoning program, allocates cognition by expected value, seeks model failure, uses less-correlated verification when worthwhile, models execution/system effects, and stops proportionally.
