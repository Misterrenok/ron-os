...
- `projects/lifeup-system.md` — current cloud-first Ron System project owner; ChatGPT is the intended controller, Neon owns derived RPG state, LifeUp is retired/rollback-only, and the stable public System Core endpoint is `https://p01--system-core--yh2fvbyd9vfg.code.run/`.
